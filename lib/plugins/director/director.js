...
ig.Director = ig.Class.extend({
  ...
  init: function(theGame, initialLevels){
    ...
    return this.loadLevelDeferred(this.currentLevel);
  },

  loadLevelDeferred: function(levelNumber){
  ...
  nextLevel: function(){
    ...
    if (this.currentLevel + 1 < this.levels.length){
      return this.loadLevelDeferred(this.currentLevel + 1);
    }
    else{
      return false;
    }
  ...
  jumpTo: function(requestedLevel){
    ...
    if (levelNumber >= 0){
      return this.loadLevelDeferred(levelNumber);
    }
    else{
      return false;
    }
  ...
  firstLevel: function(){
    ...
    return this.loadLevelDeferred(0);
  },

  lastLevel: function(){
    //Go to the last level.
    return this.loadLevelDeferred(this.levels.length - 1);
  },

  reloadLevelDeferred: function(){
