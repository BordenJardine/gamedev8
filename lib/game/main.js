    ...
    homeless = Scene.extend({
    	...
    	update: function() {
            ...
            if( player ) {
                ...
                //This should probably be in the player update yeah?
                //Justin - I think the thought is that its for controlling system-related stuff so its
                //out here. we can move it though
            }
    	},
    	...
    	draw: function() {
            ...
            // FUCK - MORE bad magic numbers. I need to clean this up
