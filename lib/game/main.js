...
homeless = Scene.extend({
	...
	init: function() {
		...
		this.levelDirector = new ig.Director(this, [LevelTestlevel, LevelSoupkitchen, LevelAI, LevelUnderworld1, LevelTutorial, LevelUberwelt, LevelOverworld]);
	...
	fadeOut: function() {
		this.fader = new ig.ScreenFader ({fade: 'out', speed: 3});
	},
	...
	drawGUI: function() {
		...
		if(this.drawBuyMenu) {
			this.menuImage.pos = {
				...
				y: (ig.system.height / 2) - (this.menuImage.image.height / 2)
			};
		...
		this.font.draw('$'+this.state.money+'.00', ig.system.width-10, ig.system.height-60,ig.Font.ALIGN.RIGHT);
	},
