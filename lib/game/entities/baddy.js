...
.defines(function() {
EntityBaddy = EntitySmart.extend({
	...
	drawFOV: function() {
		...
		var fovColor = (this.alertLevel > 0) ? "rgba(255,200,200,0.4)" : "rgba(200,255,200,0.4)";

		var halfFov = this.fovRads/2;
		var angle = this.currentAnim.angle - (90/ig.global.TO_RADS);  //why the hell do I have to add 90 degrees here?!
