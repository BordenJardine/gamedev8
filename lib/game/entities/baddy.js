...
EntityBaddy = ig.Entity.extend({
	...
	pathToWaypoint: function() {
		...
		switch(this.headingDirection) {
			case 1:
				this.currentAnim.angle = 315/TO_RADS; break;
			case 2:
				this.currentAnim.angle = 270/TO_RADS; break;
			case 3:
				this.currentAnim.angle = 225/TO_RADS; break;
			case 4:
				this.currentAnim.angle = 0/TO_RADS; break;
			case 5:
				this.currentAnim.angle = 180/TO_RADS; break;
			case 6:
				this.currentAnim.angle = 45/TO_RADS; break;
			case 7:
				this.currentAnim.angle = 90/TO_RADS; break;
			case 8:
				this.currentAnim.angle = 135/TO_RADS; break;
			default:
				this.currentAnim.angle = 0/TO_RADS; break;
		}
	},
