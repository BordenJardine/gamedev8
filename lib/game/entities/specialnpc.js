...
EntitySpecialnpc = EntityNpc.extend({
	...
	init: function( x, y, settings ) {
		...
		this.specialDialogActive = false;
	...
	ready: function() {
		...
		if(this.specialDialogKey != undefined) {
			...
			if(this.triggerOnEntry) {
				this.specialDialogActive = true;
			}
			this.parent();
	},

	update: function() {
		if(!this.specialDialogCompleted && this.specialDialogActive) {
