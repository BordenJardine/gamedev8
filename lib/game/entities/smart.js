...
EntitySmart = EntityRoutable.extend({
	...
	waitEnd: function() {
		var func = this[this.previousBehavior + 'Begin'];
		if(typeof func == 'function') this[this.previousBehavior + 'Begin']();
	},
	...
	moveRandomly: function() {
		...
		try {
			if(this.path == undefined) {
				...
				console.log('trying to path to ', rand_x, rand_y);
			}
		} catch(e) {}
	},
	...
	faceTowards: function(){
		if (this.facing == undefined || this.currentAnim.angle == this.facing && this.type != 'rotating') return;
