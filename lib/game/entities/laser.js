	...
	knockDebris: function() {
		...
		if (debrisOut < 10) {
			...
			for (var i = 0; i < numPieces; i++) {
				...
				ig.game.spawnEntity(EntityItem, x, y, { image: 7, type: 'equippable', name: 'debris' });
			}
		}
	},
	...
	update: function() {
		if (this.firing) {
			...
			if (this.preFire.delta() >= 0) {
				...
				else ig.game.spawnEntity(EntityLaserblast, this.pos.x, this.pos.y, { lifetime: 5, owner: this });
