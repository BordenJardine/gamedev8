	 ...
	 DialogGenerator = ig.Class.extend({
		...
		*/
		dialog: {
			...
			7: ['The names Beth. I have a lot to show you, but it\'s not safe here...Follow me.', 'moveToLocation', 'Ok, now let me explain...', 'moveToLocation', "AND NOW I'm OVER HERE"],
			8: ['I need you to get the Orgone Crystal from the Soup Kitchen'],
			9: ['Thanks for getting the Orgone!']
		},
