		...
		*/
		dialog: {
			...
			7: ['The names Beth. I have a lot to show you, but it\'s not safe here...Follow me.',
			 	...
			 	"Yer gunna need something to hold onto your stuff. My 'cart is over there, why don't you take it.",
			 	"waitForItem",
			 	"Alright, looking better already. You're going to need to eat and sleep too. Dumpsters like this one here are all over the city. You need to look through them to get food and survive.",
			 	"Go ahead, I'll let you get first pickin's at this one.",
			 	"[placeholder while  you check dumpster]",
			 	"I bet yer tired. You can't just go gallivanting around the city like a mad man and raiding soup kitchens and get no sleep. You need to find yerself I nice, comfortable box to sleep in.",
			...
			8: ["It took you long enough...Anyways, I know a place where they're holding on to some ORGONE CRYSTALS. We need them to [insert reason for needing the crystals].",
				"The place is a soup kitchen; they run that too. You get those crystals, and we're one step closer to taking them down."],
			9: ["Wow...I didn't think you'd actually make it. We might stick it to them yet. You know, the NSA took everything from me: my husband, my kids, my pets..."]
		},
